...
export default function Search() {
  ...
  return (
    <>
      <div
        className={`bg-[#F2F4FF] relative p-2 rounded-lg flex items-center justify-start transition-all ${
          expandSearch ? "w-full" : ""
        }`}
      >
        ...
        {searchResults.length > 0 && searchQuery !== "" && (
          <div
            ref={searchRef}
            className="bg-[#e0e3f6] absolute  top-full left-0 w-full p-2 mt-2 rounded-lg z-10"
          >
