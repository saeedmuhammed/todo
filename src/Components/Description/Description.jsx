...
export default function Description({setShowDetails , card}) {
  ...
  const {lists , setLists } = useContext(CardsContext);
 ...
 async function addDescription(){
        ...
        try {
          ...
          await axios.put(`https://strapi.techytypes.com/todos/${card.id}`, JSON.stringify(updatedCard), config);
  ...
  return (
    <div className="fixed inset-0  w-full  flex  justify-center overflow-y-auto  bg-primary bg-opacity-75 z-50" onClick={()=>setShowDetails(false)}>
      <div className=" my-10 bg-white w-3/5 h-fit  p-6  rounded-lg shadow-lg "  onClick={(e) => e.stopPropagation()}>
        <div className="my-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className=" col-span-2 w-[95%]">
            ...
            <div className="my-12">
              ...
              <p className="w-1/2 cursor-pointer py-2" onClick={()=>setShowAddDescription(true)} > {card.Description} </p>
             {showAddDescription &&  <div> 
              ...
              <div className="flex items-center">
                <button className=" bg-[#4D60FF] px-6 py-2 text-white rounded-lg text-sm" onClick={addDescription} >
                  Save
                </button>
                <div className="cursor-pointer" onClick={()=>setShowAddDescription(false)} >
