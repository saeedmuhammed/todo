    ...
    <div className="  bg-white row-start-1 col-span-1 p-3 divide-y-2  rounded-lg border-solid border-[1px] border-[#edf0ff]">
      ...
      <div className="w-full py-7 flex flex-col gap-2 ">
        <div className="">
          ...
          <h3 className="inline-block cursor-pointer">Workspaces</h3>
        </div>

        <div className="flex items-center justify-between">
          <div>
            <Man className="hidden lg:inline-block mr-2" />
            <h3 className="inline-block  cursor-pointer">Members</h3>
          </div>
          <div>
      ...
      <div className="w-full py-7  flex flex-col gap-2 ">
        <h2 className="font-bold cursor-pointer">Workspaces Views</h2>
        <div className="flex items-center justify-start">
          <BoardFilled className="hidden lg:inline-block mr-2" /> <h3 className="cursor-pointer">Table</h3>
        </div>
        <div className="flex items-center justify-start">
          <BoardFilled className="hidden lg:inline-block mr-2" />{" "}
          <h3 className="cursor-pointer">Calender</h3>
        </div>
      </div>
      <div className="w-full py-7  flex flex-col gap-2">
        <h2 className="font-bold cursor-pointer" >Your boards</h2>
        <div className="flex items-center justify-start">
          <Box className="hidden lg:inline-block mr-2 " />
          <h3 className="cursor-pointer">Mo</h3>
        </div>
      </div>
    </div>
  );
